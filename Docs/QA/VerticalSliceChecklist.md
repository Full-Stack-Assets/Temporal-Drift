...
- [ ] Replace the Canvas debug HUD with final scalable UMG presentation. *(Runtime UMG + pause/settings widgets + `WBP_*` fallbacks added; authored widget polish still pending.)*
