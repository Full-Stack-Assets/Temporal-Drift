...
bool FBTTFTemporalDriveTest::RunTest(const FString& Parameters)
{
    ...
    System->AddPlutoniumCells(2);TestFalse(TEXT("88 MPH remains mandatory"),System->CanPowerJump(ETemporalFuelType::Plutonium,87.9f,Mistyped,Error));
    TestTrue(TEXT("Plutonium powers valid jump"),System->CanPowerJump(ETemporalFuelType::Plutonium,88.0f,Mistyped,Error));TestTrue(TEXT("Fuel consumed"),System->ConsumeJumpFuel(ETemporalFuelType::Plutonium));TestEqual(TEXT("One cell remains"),System->GetSnapshot().PlutoniumCells,1);
